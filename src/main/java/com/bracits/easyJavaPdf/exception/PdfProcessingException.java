 ...
 */
public abstract class PdfProcessingException extends RuntimeException {
     ...
     */
    protected PdfProcessingException(String message) {
        super(message);
    }
     ...
     */
    protected PdfProcessingException(String message, Throwable cause) {
        super(message, cause);
    }
}